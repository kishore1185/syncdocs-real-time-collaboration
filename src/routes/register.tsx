      ...
      <div className="flex-1 bg-zinc-950 text-white p-12 flex flex-col justify-between relative overflow-hidden hidden md:flex">
        ...
        <div className="relative z-10">
          ...
          <p className="text-zinc-400 max-w-sm mt-4 text-lg">
            Create your account to start building documents together in real-time.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white dark:bg-zinc-950 relative">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-semibold tracking-tight text-zinc-900 dark:text-white">Create Account</h1>
            <p className="text-sm text-zinc-500 dark:text-zinc-400">Sign up for a new SyncDocs workspace.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="flex h-11 w-full rounded-md border border-zinc-300 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-800 dark:focus-visible:ring-zinc-300"
              />
              <p className="text-xs text-zinc-500 mt-1">Please create a new password specific to SyncDocs.</p>
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300" htmlFor="confirmPassword">
                Confirm SyncDocs Password
              </label>
              <input
                id="confirmPassword"
                type="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full inline-flex h-11 items-center justify-center rounded-md bg-zinc-900 px-8 text-sm font-medium text-zinc-50 shadow transition-colors mt-2 hover:bg-zinc-900/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50/90"
            >
          ...
          <div className="text-center text-sm">
            ...
            <Link to="/login" className="font-medium text-zinc-900 hover:underline dark:text-zinc-50">
              Sign in
            </Link>
          </div>
        </div>
